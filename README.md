...
| PALWORLD_ALLOW_NEGATIVE_DELTA_TIME         | Opt-in mitigation that sets `Pal.AllowNegativeDeltaTime=1` through an Engine ini override, bypassing Palworld's fatal termination when DeltaTime is negative; it does not correct the host clock. | false                                                                                              | true/false                                                                                                        | fork-only         |
